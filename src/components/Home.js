            ...
            <div>
                <div className="home-wrapper">
                    <form onSubmit={this.submitButton}>
                        ...
                        />
                        <h3 className="text-white">Anime and Manga Search by Category</h3>
                        <h3 className="text-white">i.e. "horror"</h3>
                        <input className="button" type="submit" value="Submit" onClick={this.randomCat} />
                    </form>
                </div>
                <br />
